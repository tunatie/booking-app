      ...
      <div className="bg-white rounded-xl max-w-xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button 
              type="submit"
              className="w-full p-3 bg-[#FF385C] text-white rounded-lg font-medium hover:bg-[#E31C5F] transition-colors"
            >
          ...
          <div className="space-y-3">
            <button className="relative w-full p-3 border border-black rounded-lg hover:bg-gray-50 bg-white">
