...
const Footer = () => {
  ...
  return (
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-[1760px] mx-auto px-24 py-12">
              ...
              <ul className="space-y-4">
                {section.links.map((link, linkIndex) => (
                  <li key={linkIndex}>
                    <a 
                      href="#" 
                      className="text-[14px] text-gray-600 hover:underline leading-5"
                    >
                      {link}
                    </a>
                  </li>
        ...
        <div className="border-t border-gray-200 mt-12 pt-6 flex flex-wrap items-center justify-between text-sm text-gray-600">
