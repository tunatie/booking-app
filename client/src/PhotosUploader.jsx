...
export default function PhotosUploader({addedPhotos, onChange}) {
    ...
    <div className="flex gap-2">
                            <input type="text" value={photoLink} onChange={e => setPhotoLink(e.target.value)} placeholder={'Add photos hered'}/>
                            <button onClick={addPhotoByLink} className="bg-gray-200 px-4 rounded-2xl whitespace-nowrap">Add photos</button>
                        </div>                       
